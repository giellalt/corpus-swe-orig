...
<xsl:variable name="filename" select="'http://www.notisum.se/rnp/sls/lag/20090724.HTM'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Lag (2009:724) om nationella minoriteter och minoritetsspråk'"/>
