...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Sex/Skydd-mot-graviditet/Akut-p-piller'"/>
	...
	<parallel_text xml:lang="smj" location="hahkka-p-tablahtta.html"/></xsl:variable>
