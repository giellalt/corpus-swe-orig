...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Karlek--vanskap/Pussar-kyssar-och-hangel'"/>
	...
	<parallel_text xml:lang="smj" location="bunestime-tjullasa-ja-hangel.html"/></xsl:variable>
