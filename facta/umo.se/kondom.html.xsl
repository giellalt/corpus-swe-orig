...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Sex/Skydd-mot-konssjukdomar/Kondom'"/>
	...
	<parallel_text xml:lang="smj" location="buohtjaskuovddo.html"/></xsl:variable>
