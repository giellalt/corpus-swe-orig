...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Nationella-minoritetssprak'"/>
	...
	<parallel_text xml:lang="smj" location="minoritetssprakstext.html"/></xsl:variable>
