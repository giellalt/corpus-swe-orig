...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samernas.se/utbildningar/geasse-sommarkurser'"/>
	...
	<parallel_text xml:lang="smj" location="_799-2_759-2__lang_ls8.html"/></xsl:variable>
