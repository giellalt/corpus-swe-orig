...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samernas.se/utbildningar/sprakgrupper-2013-14'"/>
	...
	<parallel_text xml:lang="smj" location="_799-2_giellajuohkusa__lang_ls7.html"/></xsl:variable>
