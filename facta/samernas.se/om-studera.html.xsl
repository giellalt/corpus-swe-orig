...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samernas.se/om-samernas/studera-pa-samernas'"/>
    ...
    <parallel_text xml:lang="smj" location="om-studera.html"/></xsl:variable>
