...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samernas.se/bokningarblanketter/boende'"/>
	...
	<parallel_text xml:lang="smj" location="_hatte_714-2__lang_ls14.html"/></xsl:variable>
