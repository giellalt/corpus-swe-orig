...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.vaajma.com/jscripts/tiny_mce/plugins/filemanager/files/Tidningen_Vaajma/Nr_1_2014.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="nr_1_2014.pdf"/></xsl:variable>


    <!-- For page oriented documents, mark which pages should be ignored -->
    <xsl:variable name="skip_pages" select="'1-4,6-11,13-17'"/>
