...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Tema/Cancer/Oversattningar--Translations/Svenska/F-HB-blod-i-avforingen'"/>
	...
	<parallel_text xml:lang="rus" location="blod_i_avforingen.html"/></xsl:variable>
