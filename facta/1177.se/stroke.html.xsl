...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Tema/Stroke/Att-fa-en-stroke/Stroke'"/>
	...
	<parallel_text xml:lang="fin" location="stroke---slaganfall.html"/></xsl:variable>
