...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Tema/Tander/Skotsel/Borsta-tander'"/>
	...
	<parallel_text xml:lang="rus" location="borsta-tander1.html"/></xsl:variable>
