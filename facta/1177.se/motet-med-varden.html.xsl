...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Regler-och-rattigheter/Motet-med-varden'"/>
	...
	<parallel_text xml:lang="sme" location="forbered-ditt-lakarbesok--tio-tips-.html"/></xsl:variable>
