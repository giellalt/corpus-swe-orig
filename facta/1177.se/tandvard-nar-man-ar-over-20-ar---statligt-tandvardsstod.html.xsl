...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Regler-och-rattigheter/Tandvard-nar-man-ar-over-20-ar---statligt-tandvardsstod'"/>
	...
	<parallel_text xml:lang="sme" location="tandvard-nar-man-ar-over-20-ar---statligt-tandvardsstod.html"/></xsl:variable>
