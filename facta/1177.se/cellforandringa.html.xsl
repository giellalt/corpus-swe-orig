...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Tema/Cancer/Oversattningar--Translations/Svenska/Cellforandringa'"/>
	...
	<parallel_text xml:lang="rus" location="cellforandringar-i-livmoderhalsen.html"/></xsl:variable>
