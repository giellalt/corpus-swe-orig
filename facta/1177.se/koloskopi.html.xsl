...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Tema/Cancer/Oversattningar--Translations/Svenska/Koloskopi'"/>
	...
	<parallel_text xml:lang="rus" location="koloskopi.html"/></xsl:variable>
