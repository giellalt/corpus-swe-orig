...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Regler-och-rattigheter/Vard-i-Sverige-om-man-ar-asylsokande'"/>
	...
	<parallel_text xml:lang="sme" location="vard-i-sverige-om-man-ar-asylsokande-gomd-eller-papperslos.html"/></xsl:variable>
