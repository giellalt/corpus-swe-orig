...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Tema/Tander/Barn/Borsta-tander-pa-barn'"/>
	...
	<parallel_text xml:lang="rus" location="brushing-childrens-teeth.html"/></xsl:variable>
