...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Regler-och-rattigheter/Sarskilt-tandvardsbidrag'"/>
	...
	<parallel_text xml:lang="sme" location="sarskilt-tandvardsbidrag.html"/></xsl:variable>
