...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Regler-och-rattigheter/Tandvard-i-Sverige-om-man-kommer-fran-ett-annat-land'"/>
	...
	<parallel_text xml:lang="rus" location="tandvard-i-sverige---vad-galler.html"/></xsl:variable>
