...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Tema/Patientlagen/Valja-vard/Valja-vardmottagning'"/>
	...
	<parallel_text xml:lang="sme" location="vardval.html"/></xsl:variable>
