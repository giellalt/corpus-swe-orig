...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Tema/Barn-och-foraldrar/Mat-somn-och-praktiska-rad/Tips-och-rad-om-barnsakerhet/Barnsakerhet-over-1-ar'"/>
	...
	<parallel_text xml:lang="fin" location="barnsakerhet-over-1-ar.html"/></xsl:variable>
