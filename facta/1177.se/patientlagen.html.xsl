...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Tema/Patientlagen/Forsta-och-vara-delaktig/Patientlagen'"/>
	...
	<parallel_text xml:lang="smj" location="patientlagen.html"/></xsl:variable>
