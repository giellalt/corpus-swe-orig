...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'Så fungerar vården - underlag översättningar - eng elska (2) (1).docx'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fit" location="meki_sa_fungerar_varden_-_underlag_oversattningar_-_eng_elska_2_1_.docx"/>
