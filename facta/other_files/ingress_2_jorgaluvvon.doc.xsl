...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <language xml:lang="swe"/><language xml:lang="sma"/><language xml:lang="sme"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="ingress_2_jorgaluvvon.doc"/>
        <parallel_text xml:lang="sme" location="ingress_2_jorgaluvvon.doc"/>
