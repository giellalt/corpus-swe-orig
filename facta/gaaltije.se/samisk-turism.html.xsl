...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.gaaltije.se/sv/samisk-turism.html'"/>
    ...
    <parallel_text xml:lang="sma" location="saemien-turismeoevtiedimmie.html"/></xsl:variable>
