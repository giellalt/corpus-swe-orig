...
<xsl:variable name="filename" select="'http://www.lansstyrelsen.se/dalarna/Sv/lantbruk-och-landsbygd/djurhallning/Pages/default.aspx'"/>
...
<xsl:variable name="parallels">
  ...
  <!-- <parallel_text xml:lang="swe" location=""/> -->
	...
	<parallel_text xml:lang="eng" location="lantbruk-och-landsbygd-djurhallning.html"/>
</xsl:variable>
