...
<xsl:variable name="filename" select="'http://www.lansstyrelsen.se/dalarna/Sv/om-lansstyrelsen/forfattningar/Pages/default.aspx'"/>
...
<xsl:variable name="parallels">
  ...
  <!-- <parallel_text xml:lang="swe" location=""/> -->
	...
	<parallel_text xml:lang="eng" location="om-lansstyrelsen-forfattningar.html"/>
</xsl:variable>
