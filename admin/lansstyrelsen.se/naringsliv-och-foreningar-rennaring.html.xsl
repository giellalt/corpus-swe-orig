...
<xsl:variable name="filename" select="'http://www.lansstyrelsen.se/dalarna/Sv/naringsliv-och-foreningar/rennaring/Pages/default.aspx'"/>
...
<xsl:variable name="parallels">
  ...
  <!-- <parallel_text xml:lang="swe" location=""/> -->
	...
	<parallel_text xml:lang="eng" location="naringsliv-och-foreningar-rennaring.html"/>
</xsl:variable>
