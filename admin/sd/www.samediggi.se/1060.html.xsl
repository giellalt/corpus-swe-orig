...
<xsl:variable name="filename" select="'http://www.samediggi.se/1060'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="2232.html" xml:lang="sma"/>
	<parallel_text location="5056.html" xml:lang="sme"/>
</xsl:variable>
