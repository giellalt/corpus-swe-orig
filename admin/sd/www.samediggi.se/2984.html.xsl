...
<xsl:variable name="filename" select="'http://www.samediggi.se/2984'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="2993.html" xml:lang="sma"/>
	<parallel_text location="2994.html" xml:lang="sme"/>
</xsl:variable>
