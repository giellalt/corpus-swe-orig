...
<xsl:variable name="filename" select="'http://www.sametinget.se/7366'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sametingets Livsmiljöprogram
EALLINBIRAS'"/>
...
<xsl:variable name="para_smj" select="'livsmiljoprogram.pdf'"/>
