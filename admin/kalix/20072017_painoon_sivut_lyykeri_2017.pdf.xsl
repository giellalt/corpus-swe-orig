...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'20072017_Painoon_sivut_LYYKERI 2017.pdf'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Bengt'"/>
    <xsl:variable name="author1_ln" select="'Pohjanen'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="author1_born" select="'19440626'"/>
    <!--
