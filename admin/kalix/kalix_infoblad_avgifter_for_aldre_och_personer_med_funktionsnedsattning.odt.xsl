...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'KALIX INFOBLAD Avgifter för Äldre och personer med funktionsnedsättning.docx'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="swe" location="kalix_infoblad_avgifter_for_aldre_och_personer_med_funktionsnedsattning.docx"/>
    </xsl:variable>
