...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://jll.se/hogerlist/press/pressmeddelanden/pressmeddelandenarkiv/nyttavtalforsvensknorsksamverkanomsamiskhalsaorrelatjkoesveerjennoorjengaskemsaemienhealsoenbijrelaavenjostedh.5.2e9572e314b74d1c524680.html'"/>
    ...
    <xsl:variable name="mainlang" select="'swe'"/>
    ...
    <parallel_text xml:lang="sma" location="nyttavtalforsvensknorsksamverkanomsamiskhalsaorrelatjkoesveerjennoorjengaskemsaemienhealsoenbijrelaavenjostedh.5.2e9572e314b74d1c524680.html"/></xsl:variable>
