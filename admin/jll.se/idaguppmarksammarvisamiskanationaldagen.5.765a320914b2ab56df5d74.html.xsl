...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://jll.se/nyheternotiser/nyheter/jll/idaguppmarksammarvisamiskanationaldagen.5.765a320914b2ab56df5d74.html'"/>
    ...
    <parallel_text xml:lang="sma" location="idaguppmarksammarvisamiskanationaldagen.5.765a320914b2ab56df5d74.html"/></xsl:variable>
