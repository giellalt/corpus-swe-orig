...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.svenskakyrkan.se/default.aspx?id=1022005'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="folder_kyrkoval2013_sydsamiska.pdf"/>
        <parallel_text xml:lang="sme" location="folder_kyrkoval2013_nordsamiska.pdf"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location=""/>
        <parallel_text xml:lang="swe" location=""/>
    <parallel_text xml:lang="rmy-rka" location="folder_kyrkoval2013_romani_kelderash.pdf"/>
</xsl:variable>
