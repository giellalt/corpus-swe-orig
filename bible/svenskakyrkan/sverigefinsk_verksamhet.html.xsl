...
<xsl:variable name="filename" select="'http://www.svenskakyrkan.se/harnosandsstift/sverigefinsk%20verksamhet'"/>
...
<xsl:variable name="parallels">
  ...
  <!-- <parallel_text xml:lang="swe" location=""/> -->
	<parallel_text xml:lang="fin" location="default.aspx_id=650396.html"/>
</xsl:variable>
